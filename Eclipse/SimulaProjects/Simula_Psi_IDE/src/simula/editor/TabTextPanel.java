...
public abstract class TabTextPanel extends JPanel {
	/// DEBUG on/off
	...
	/// The ScrollPane
	protected JScrollPane styleScrollPane;
...
//        Palette.printColors("NEW TabTextPanel: ");
...
//	    fillTextPane(new StringReader(txt),pos+count);
		Util.IERR("Missing redef: doRefresh");
	}
