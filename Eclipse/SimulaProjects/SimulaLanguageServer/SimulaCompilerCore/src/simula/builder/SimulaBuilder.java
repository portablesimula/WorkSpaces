...
//	private LexToken prevWasNEWLINE = null; // Used by LEX_VERIFY
...
//		this.sourceDocumentItem = sourceDocumentItem;
	...
	public void start(CharSequence sourceText) {
        ...
        scanner = new SimulaLexer(sourceText);
	}
...
//		IO.println("PsiBuilder.doneTokenRange: syntaxElement="+syntaxElement);
	...
	public void advanceLexer() {
		...
		scanner.nextToken();                            // And then advance the lexer.				
	}
...
//		if(Option.TESTING_WITHOUT_PSI) {
			return scanner.getPrevLexerToken();
//		} else {
...
//		if(Option.TESTING_WITHOUT_PSI) {
			return scanner.getPrevParserToken();
//		} else {
...
//		}
	...
	public boolean eof() {
		return scanner.EOF != null;
	}

	public LexToken getCurrentLexerToken() {
		return scanner.getCurrentLexerToken();
	}
