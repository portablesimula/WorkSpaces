...
//	}
	...
	public static void syntaxError(final PsiBuilder psiBuilder, final String msg) {
		syntaxError(psiBuilder, psiBuilder.prevParserToken(), msg);
	}
	
	public static void syntaxError(final PsiBuilder psiBuilder, final LexToken token, final String msg) {
...
//        Position end = new Position(error.getLine() - 1, error.getCharPosition() + error.getLength());
        Position start = new Position(token.lineNumber - 1, token.startOffset);
        Position end = new Position(token.lineNumber - 1, token.endOffset);
