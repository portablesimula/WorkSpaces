...
//		PsiBuilder astBuilder = new PsiBuilder();
//		try {
////			astBuilder.start(getOriginalText());
//			astBuilder.start(getUpdatedText());
//    		IO.println("SourceModule.buildPsiAndSyntaxTrees: " + getUpdatedText().replace("\n", "\\n").replace("\r", "\\r"));
//			syntaxTree = new ProgramModule(astBuilder);
//		} catch (Exception e) {
