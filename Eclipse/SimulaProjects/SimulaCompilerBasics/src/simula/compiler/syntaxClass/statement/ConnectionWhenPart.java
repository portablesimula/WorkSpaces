...
public final class ConnectionWhenPart extends ConnectionDoPart {
	...
	public ConnectionWhenPart(final AstBuilder astBuilder, final ConnectionStatement connectionStatement, final String classIdentifier,final ConnectionBlock connectionBlock,final Statement statement) {
		super(astBuilder, connectionStatement, connectionBlock, statement);
