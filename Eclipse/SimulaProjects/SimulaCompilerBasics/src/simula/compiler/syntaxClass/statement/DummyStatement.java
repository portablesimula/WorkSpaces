...
//	}
	private DummyStatement(final AstBuilder astBuilder) {
		super(astBuilder);
	}

	public static DummyStatement ofExplicit(final AstBuilder astBuilder) {
		astBuilder.consume(KeyWord.SEMICOLON); //  (add it to 'current tree')
		DummyStatement dummyStatement = new DummyStatement(astBuilder);		
		return dummyStatement;
	}

	public static DummyStatement ofImplicit(final AstBuilder astBuilder) {
		DummyStatement dummyStatement = new DummyStatement(astBuilder);		
		return dummyStatement;
	}
