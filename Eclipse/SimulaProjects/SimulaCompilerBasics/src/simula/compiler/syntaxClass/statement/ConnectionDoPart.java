...
public class ConnectionDoPart extends SyntaxElement {
	...
	ConnectionDoPart(final AstBuilder astBuilder, final ConnectionStatement connectionStatement, final ConnectionBlock connectionBlock,final Statement statement) {
		super(astBuilder);
