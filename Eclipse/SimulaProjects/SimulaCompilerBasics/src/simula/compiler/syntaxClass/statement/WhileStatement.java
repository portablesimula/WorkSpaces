...
public final class WhileStatement extends Statement {
	...
	WhileStatement(final AstBuilder astBuilder) {
		super(astBuilder);
		astBuilder.consume(KeyWord.WHILE); //  (add it to 'current tree')

//		if (Option.internal.TRACE_PARSE)
//			Util.TRACE("Parse WhileStatement: line="+line+", current=" + PsiParse.currentLexToken(astBuilder));
		condition = Expression.expectExpression(astBuilder, "while");
		PsiParse.expect(astBuilder, KeyWord.DO);
		doStatement = Statement.acceptStatement(astBuilder);
