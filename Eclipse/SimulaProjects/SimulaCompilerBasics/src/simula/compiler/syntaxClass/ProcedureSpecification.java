...
public final class ProcedureSpecification extends SyntaxElement {
	...
	public ProcedureSpecification(final AstBuilder astBuilder, final String identifier, final Type type, final ObjectList<Parameter> pList) {
		super(astBuilder);
	...
	public static ProcedureSpecification expectProcedureSpecification(final AstBuilder astBuilder, final Type type) {
//		IO.println("\n\nProcedureSpecification.expectProcedureSpecification: BEFORE expectProcedureDeclaration");
		ProcedureDeclaration block = ProcedureDeclaration.expectProcedureDeclaration(astBuilder, type);
//		IO.println("\n\nProcedureSpecification.expectProcedureSpecification: AFTER expectProcedureDeclaration: "+block);
		PsiParse.expect(astBuilder, KeyWord.SEMICOLON); // TODO: DENNE ER NY !
		if (Option.internal.TRACE_PARSE)
			Util.TRACE("END ProcedureSpecification: " + block);
		Global.setScope(block.declaredIn);
		ProcedureSpecification procedureSpecification = new ProcedureSpecification(astBuilder, block.identifier, type, block.parameterList);
