...
public final class TextExpression extends Expression {
	...
	TextExpression(final AstBuilder astBuilder, final Expression lhs, final Expression rhs) {
		super(astBuilder);
		this.lhs = lhs; this.rhs = rhs;
//		astBuilder.startSubtree(PsiTree.Kind.textExpression, "TextExpression");
		if (this.lhs == null) {
			Util.syntaxError(astBuilder, "Missing operand before &");
			this.lhs = new MissingExpression(astBuilder);
		}
		if (this.rhs == null) {
			Util.syntaxError(astBuilder, "Missing operand after &");
			this.rhs = new MissingExpression(astBuilder);
		}
		this.lhs.backLink = this.rhs.backLink = this;
//		astBuilder.doneSubtree(PsiTree.Kind.textExpression, this);
	}
