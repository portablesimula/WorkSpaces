...
public final class BooleanExpression extends Expression {
	...
	BooleanExpression(final AstBuilder astBuilder, Expression lhs, int opr, Expression rhs) {
		super(astBuilder);
		this.lhs = lhs; this.opr = opr; this.rhs = rhs;
//		astBuilder.startSubtree(PsiTree.Kind.booleanExpression, "BooleanExpression");
...
//		astBuilder.doneSubtree(PsiTree.Kind.booleanExpression, this);
	}
