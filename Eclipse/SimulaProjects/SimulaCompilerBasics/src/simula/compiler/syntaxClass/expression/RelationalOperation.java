...
public final class RelationalOperation extends Expression {
	...
	RelationalOperation(final AstBuilder astBuilder, final Expression lhs,final int opr,final Expression rhs) {
		super(astBuilder);
...
//		astBuilder.doneSubtree(PsiTree.Kind.relationalOperation, this);
	}
