...
public final class VirtualMatch extends Declaration {
	...
	VirtualMatch(final AstBuilder astBuilder, final VirtualSpecification virtualSpec, final ProcedureDeclaration match) {
		super(astBuilder, virtualSpec.identifier);
