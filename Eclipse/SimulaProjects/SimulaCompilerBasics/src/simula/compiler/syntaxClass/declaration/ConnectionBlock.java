...
public final class ConnectionBlock extends DeclarationScope {
	...
	public ConnectionBlock(final AstBuilder astBuilder, final VariableExpression inspectedVariable, final String whenClassIdentifier) {
//		super("Connection block at line " + (Global.sourceLineNumber - 1));
		super(astBuilder, "Inspect " + inspectedVariable);
