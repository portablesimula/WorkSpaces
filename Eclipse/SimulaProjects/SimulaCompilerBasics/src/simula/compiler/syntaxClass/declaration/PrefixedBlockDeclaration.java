...
public final class PrefixedBlockDeclaration extends ClassDeclaration {
	...
	private PrefixedBlockDeclaration(final AstBuilder astBuilder, final boolean isMainModule) {
		super(astBuilder, null);
//		if(isMainModule)
...
//		else modifyIdentifier("PBLK" + firstLineNumber());
	...
	public static PrefixedBlockDeclaration expectPrefixedBlock(final AstBuilder astBuilder, final VariableExpression blockPrefix,boolean isMainModule) {
		PrefixedBlockDeclaration block=new PrefixedBlockDeclaration(astBuilder, isMainModule);
