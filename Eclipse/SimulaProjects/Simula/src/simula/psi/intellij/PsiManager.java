...
*/
@Deprecated
public abstract  PsiFile findFile( VirtualFile file,  CodeInsightContext context);
...
*/
@Deprecated
public abstract  FileViewProvider findViewProvider( VirtualFile file,  CodeInsightContext context);
...
*/
public abstract <T> T runInBatchFilesMode( Computable<T> runnable);
...
public abstract  FileViewProvider findCachedViewProvider( VirtualFile vFile);
}