...
ArrayFactory<PsiElement> ARRAY_FACTORY = null;// count -> count == 0 ? EMPTY_ARRAY : new PsiElement[count];
...
*/
default Collection<? extends  PsiSymbolDeclaration> getOwnDeclarations() {
