...
//	}
	...
	public String edTokenText(SimulaLexer lexer) {
		int tokenStartPos = lexer.getLineStartPos(lineNumber) + column;
		IO.println("LexToken.edTokenText: tokenStartPos="+tokenStartPos);
	...
	public String edToken(SimulaLexer lexer) {
		String str = edTokenText(lexer).replace("\r", "\\r").replace("\n", "\\n");
		return "Line " + lineNumber + ": " + KeyWord.edit(keyWord) + "[col:" + column + ", lng:" + length + "]=\"" + str + '"';
	}

	@Override
	public String toString() {
		String str = tokenText.replace("\r", "\\r").replace("\n", "\\n");
