...
public interface Application extends ComponentManager {
   ...
   */
  //@ApiStatus.Obsolete
  default void invokeLaterOnWriteThread(Runnable action, ModalityState modal, Condition<?> expired) {
  ...
  @SuppressWarnings("LambdaUnfriendlyMethodOverload")
  //@RequiresBlockingContext
  <T, E extends Throwable> T runReadAction(ThrowableComputable<T, E> computation) throws E;
  ...
  default <T, E extends Throwable> T runWriteIntentReadAction(ThrowableComputable<T, E> computation) throws E {
   ...
   */
  //@RequiresBlockingContext
  void invokeLater(Runnable runnable, Condition<?> expired);
   ...
   */
  //@RequiresBlockingContext
  void invokeLater(Runnable runnable, ModalityState state, Condition<?> expired);
