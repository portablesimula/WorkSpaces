...
//	    Icon icon = findIconUsingDeprecatedImplementation(path, aClass.getClassLoader(), aClass, false);
//	    
//	    if (icon == null) {
...
//	    return icon;
//	}
//	public static Icon getIcon(String string, Class<SimulaIcons> class1) {
