...
//	private static final Logger LOG = Logger.getInstance(TokenSequence.class);
	...
	public static @NotNull TokenList performLexing(@NotNull CharSequence text, @NotNull Lexer lexer) {
		LOG.println("TokenSequence.performLexing: lexer: "+lexer.getClass().getSimpleName());
	...
	private static class Builder {
		...
		Builder(@NotNull CharSequence text, @NotNull Lexer lexer) {
			LOG.println("NEW TokenSequence'Builder: lexer: "+lexer.getClass().getSimpleName());
			myText = text;
			myLexer = lexer;
		...
		@NotNull TokenSequence performLexing() {
			LOG.println("TokenSequence'Builder.performLexing: myLexer: "+myLexer.getClass().getSimpleName());
