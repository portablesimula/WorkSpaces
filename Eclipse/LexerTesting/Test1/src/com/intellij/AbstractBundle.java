...
public class AbstractBundle {
	...
	public AbstractBundle(Class<UtilBundle> class1, String bundle) {
		// TODO Auto-generated constructor stub
	}

	public @NotNull @Nls String getMessage(@NotNull @PropertyKey(resourceBundle = "messages.UtilBundle") String key,
