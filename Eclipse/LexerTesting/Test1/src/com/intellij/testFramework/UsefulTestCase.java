...
//  private static CodeInsightSettings defaultSettings = new CodeInsightSettings();
  ...
  static {
	  System.out.println("UsefulTestCase'static Block: CODE REMOVED");
...
//  };
  ...
  public UsefulTestCase(@NotNull String name) {
	  System.out.println("NEW UsefulTestCase: CODE REMOVED");
//	  super(name);
  }

  protected void checkShouldRunTest() {// throws AssumptionViolatedException {
	  System.out.println("UsefulTestCase.checkShouldRunTest: CODE REMOVED");
//	  assertTrue("skipped: shouldRunTest() returned false", shouldRunTest());
  }
...
//  @Override
  protected void setUp() throws Exception {
	  System.out.println("UsefulTestCase.checkShouldRunTest: CODE REMOVED-1");
//	  super.setUp();
//
...
//	  Disposer.setDebugMode(!isStressTest);
	  ...
	  System.out.println("UsefulTestCase.checkShouldRunTest: CODE REMOVED-2");
//	  if (isIconRequired()) {
...
//	  }
  ...
  @NotNull Path createGlobalTempDirectory() throws IOException {
	  ...
	  if (testName == null) {
		  System.out.println("UsefulTestCase.removeGlobalTempDirectory: CODE CHANGED");
//		  testName = FileUtil.sanitizeFileName(getTestName(true));
		  testName = "FunnyTEST_Name";
	  }
  ...
  void removeGlobalTempDirectory(@NotNull Path dir) throws Exception {
	  System.out.println("UsefulTestCase.removeGlobalTempDirectory: CODE REMOVED");
...
//  @Override
  ...
  protected void tearDown() throws Exception {
	  System.out.println("UsefulTestCase.tearDown: CODE REMOVED");
...
//			  ).run(mySuppressedExceptions);
  ...
  private static void checkContextJobCanceled() {
	  System.out.println("UsefulTestCase.checkContextJobCanceled: CODE REMOVED");
...
//	  }
  ...
  static void doCheckForSettingsDamage(@NotNull CodeStyleSettings oldCodeStyleSettings,
	  ...
	  System.out.println("UsefulTestCase.doCheckForSettingsDamage: CODE REMOVED");
...
//			  ).run();
  ...
  public @NotNull Disposable getTestRootDisposable() {
	  ...
	  System.out.println("UsefulTestCase.doCheckForSettingsDamage: CODE CHANGED");
	  if (disposable == null) {
...
//  throw new UnsupportedOperationException("Use runTestRunnable() to override the way tests are executed");
    throw new RuntimeException("Use runTestRunnable() to override the way tests are executed");
  }
...
//  @Override
  public final void runBare() throws Throwable {
	  System.out.println("UsefulTestCase.runBare-1: CODE REMOVED");
//    if (shouldRunTest()) {
...
//    }
  ...
  protected void runBare(@NotNull ThrowableRunnable<Throwable> testRunnable) throws Throwable {
	  System.out.println("UsefulTestCase.runBare-2: CODE REMOVED");
