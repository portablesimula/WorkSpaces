...
public interface SimpleMessageBusConnection {
   ...
   */
  <L> void subscribe(@NotNull Topic<L> topic, @NotNull L handler);

  /**
   * Disconnects current connections from the {@link MessageBus} and drops all queued but not dispatched messages (if any)
   */
  void disconnect();
}
