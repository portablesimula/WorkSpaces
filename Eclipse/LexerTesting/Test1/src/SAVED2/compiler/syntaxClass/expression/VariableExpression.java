...
/// "https://github.com/portablesimula/WorkSpaces/Eclipse/blob/main/SimulaCompiler2/Simula/src/simula/compiler/syntaxClass/expression/VariableExpression.java">
/// <b>Source File</b></a>.
/// 
...
//	}
	...
	public static VariableExpression expectVariable(final PsiBuilder simBuilder, final String ident) {
		if (Option.internal.TRACE_PARSE)
			Util.TRACE("Parse Variable, current=" + Parse.currentToken(simBuilder));// + ", prev=" + Parse.prevToken);
