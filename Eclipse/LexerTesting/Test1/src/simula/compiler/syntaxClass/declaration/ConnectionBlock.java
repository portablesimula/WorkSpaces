...
/// "https://github.com/portablesimula/WorkSpaces/Eclipse/blob/main/SimulaCompiler2/Simula/src/simula/compiler/syntaxClass/declaration/ConnectionBlock.java">
/// <b>Source File</b></a>.
/// 
...
public final class ConnectionBlock extends DeclarationScope {
	...
	public ConnectionBlock(final VariableExpression inspectedVariable, final String whenClassIdentifier) {
		super("ConnectionBlock", "Connection block at line " + (Global.sourceLineNumber - 1));
...
//	}
	...
	public ConnectionBlock(String identifier) {
		super("ConnectionBlock", identifier);
		declarationKind = ObjectKind.ConnectionBlock;
	}
