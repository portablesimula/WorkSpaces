package simula.plugin.extensions.highlighter.syntaxHighlighter;
...
import simula.lang.SimulaTypes;
...
//        if (tokenType.equals(SimulaElementTypes.KEYWORD)) return KEY_KEYS;
        if (tokenType instanceof KeyWordToken) return KEY_KEYS;
