...
public interface IntList extends IntCollection, Comparable<List<? extends Integer>>, List<Integer> {
    ...
    default IntSpliterator spliterator() {
        return (IntSpliterator)(this instanceof RandomAccess ? new AbstractIntList.IndexBasedSpliterator(this, 0) : IntSpliterators.asSpliterator(this.iterator(), Size64.sizeOf(this), 16720));
    }
    ...
    default void replaceAll(it.unimi.dsi.fastutil.ints.IntUnaryOperator operator) {
    ...
    default void replaceAll(UnaryOperator<Integer> operator) {
        ...
        IntUnaryOperator var10001;
        if (operator instanceof IntUnaryOperator) {
            var10001 = (IntUnaryOperator)operator;
        } else {
            Objects.requireNonNull(operator);
