...
public class ReferenceOpenHashSet<K> extends AbstractReferenceSet<K> implements Hash, Serializable, Cloneable {
        ...
        public K next() {
            if (!this.hasNext()) {
                ...
                if (this.mustReturnNull) {
                    ...
                    return (K)key[ReferenceOpenHashSet.this.n];
                } else {
                    while(--this.pos >= 0) {
                        if (key[this.pos] != null) {
                            return (K)key[this.last = this.pos];
                        }
                    }

                    this.last = Integer.MIN_VALUE;
                    return (K)this.wrapped.get(-this.pos - 1);
                }
            }
        }
