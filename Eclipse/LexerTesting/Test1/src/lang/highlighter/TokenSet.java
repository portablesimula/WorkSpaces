...
public final class TokenSet {
  ...
  private TokenSet(short shift, short max, IElementType.Predicate orCondition) {
    myShift = shift;
    myMax = max;
   ...
   */
  public static TokenSet forAllMatching(IElementType.Predicate condition) {
  ...
  private static class OrPredicate implements IElementType.Predicate {
    ...
    @Override
    public boolean matches(IElementType t) {
