...
import lang.scanner.util.Option;
...
//    private ScannedToken currentToken;
//    private SimulaScanner scanner;
    ...
    @Override
    public void advance() {
    	if(DEBUG > 1) System.out.println("\nSimpleManualLexer.advance:"+" currentPosition="+currentPosition
	    ...
	    if(DEBUG > 0)  {
        	...
        	System.out.println("SimpleManualLexer.advance: "+tokenElementType+'['+tokenStartOffset+':'+tokenEndOffset+"]=\""+txt+"\"\n");
    	}
...
//        return textEndOffset;
    ...
    public IElementType getTokenType() {
    	if(DEBUG > 1) System.out.println("SimpleManualLexer.getTokenType: "+tokenElementType);
...
//	            	break;
	            ...
	            default:
//	            	Util.error("Illegal character: "+(char)current+", Value="+(int)current);
//	                break;
...
//    	Token token=SimulaTokenType.IDENTIFIER;
//    	return(token);
//    }
...
//    		IElementType cc=scanDirectiveLine();
//    		tokenQueue.add(cc);
//			current=' '; return(true);
		}
...
//	private IElementType scanDirectiveLine() {
//		getNext();
//		if(current==' ') {
//			readUntilEndofLine(); // Skip comment line
//		    return SimulaTokenType.COMMENT;
...
//		if(editorMode && accum.length()>0) tokenQueue.add(SimulaTokenType.COMMENT);
    ...
    private int getNext() {
    	...
    	if(currentPosition >= textEndOffset) {
    		...
    		current = this.sourceText.charAt(this.currentPosition++);
    	}
    	return current;
    }
