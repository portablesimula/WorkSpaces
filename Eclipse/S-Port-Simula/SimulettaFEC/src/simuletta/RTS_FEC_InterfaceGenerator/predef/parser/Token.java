...
//import predef.AttributeInput;
//import predef.AttributeOutput;
...
public final class Token {
	...
	public final static Token ARRAY     =new Token(KeyWord.ARRAY);
...
//	public final static Token CALL	    =new Token(KeyWord.CALL);
	...
	public final static Token CLASS    =new Token(KeyWord.CLASS);
...
//	public final static Token REM       =new Token(KeyWord.REM);
	...
	public final static Token PROCEDURE =new Token(KeyWord.PROCEDURE);
	public final static Token SHORT  	=new Token(KeyWord.SHORT);
	public final static Token SEMICOLON =new Token(KeyWord.SEMICOLON);
	...
	public final static Token TEXT	    =new Token(KeyWord.TEXT);
	public final static Token VALUE     =new Token(KeyWord.VALUE);
