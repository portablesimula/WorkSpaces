...
import sim.editor.scanner.DefaultScanner;
import sim.editor.scanner.SimulaScanner;
import sim.editor.scanner.Token;
...
public class SourceTextPanel extends JPanel {
    ...
    private UndoableEditListener undoListener=new UndoableEditListener() {
		public void undoableEditHappened(UndoableEditEvent e) {
			...
			SPortEditor.menuBar.updateMenuItems();
		}
	};
    ...
    SourceTextPanel(File sourceFile,SPortEditor.Language lang,JPopupMenu popupMenu) {
