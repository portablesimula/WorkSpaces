 ...
 */
public final class SPortExtractor extends JFrame {
...
//		if (answer == 0) mainFrame.setVisible(true);
		...
		if(INSTALL_DIR.exists()) {
			...
			int result = JOptionPane.showOptionDialog(SPortExtractor.this, msg2, "Warning",
...
//			} else {
			if (!jarFile.exists()) {
				...
				JOptionPane.showMessageDialog(SPortExtractor.this, msg, title, JOptionPane.INFORMATION_MESSAGE);
			}
		} catch (Exception e) {
