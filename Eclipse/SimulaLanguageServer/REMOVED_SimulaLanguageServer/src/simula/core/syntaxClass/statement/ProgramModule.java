...
//		Util.println("NEW ProgramModule: sysout.meaning="+sysout.meaning);
	}
...
//			    	Util.println("ProgramModule.doBuild: IDENTIFIER ...");
...
//					Util.println("NEW ProgramModule: tokenAfter: " + simBuilder.tokenList.get(i));
					sb.append(simBuilder.lexTokenList.get(i).getText());
				}
				String textAfterEnd = Comn.printable(sb.toString());
//				Util.println("NEW ProgramModule: TextAfterEnd: " + Comn.printable(textAfterEnd));
...
//		simBuilder.getRoot().printPsiTree("DONE ProgramModule.doParseProgram");
	...
	public void doChecking() {
		...
		sysin.doChecking();
//		Util.println("ProgramModule.doChecking: BEFORE SYSOUT: sysout.meaning="+sysout.meaning);
		sysout.doChecking();
//		Util.println("ProgramModule.doChecking: AFTER SYSOUT: sysout.meaning="+sysout.meaning);
//		Util.IERR("");
	...
	public void printTree(final int indent) {
		Util.println("BASICIO");
		Util.println("    ... Standard Classes and Procedures");
