...
//		Util.println("StandardClass.initCatchingErrors: ENVIRONMENT.declarationList: " + ENVIRONMENT.declarationList);
...
//		Util.println("StandardClass.findRemoteAttributeMeaning: " + identifierValue() + ", TRY FIND: "+ident.value);
		for(Declaration declaration:declarationList) {
//			Util.println("StandardClass.findRemoteAttributeMeaning: CHECK: " + declaration.identifierValue() + ", find: "+ident);
			if(Util.equals(ident, declaration.identifier)) {
				return(new Meaning(declaration,this));
			}
		}
