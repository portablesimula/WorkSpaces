...
public class IdentifierToken extends LexToken {
	public final String value;

	public IdentifierToken(int tokenStartLine, CharSequence sourceText, int column, int length, SimulaLexer lexer) {
