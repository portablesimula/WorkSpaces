...
/// "https://github.com/portablesimula/WorkSpaces/blob/main/Eclipse/SimulaProjects/Simula/src/simula/compiler/utilities/Token.java"><b>Source File</b></a>.
/// 
/// @author Øystein Myhre Andersen
public final class REMOVE_Token {
	...
	public REMOVE_Token(final String text, final int keyWord, final Object value) {
		this.text = text;
	...
	/// @param text    the Token's text attribute
	/// @param keyWord the Token's keyword attribute
	public REMOVE_Token(final String text, final int keyWord) {
	...
	/// @param keyWord the Token's keyword attribute
	/// @param value   the Token's value attribute
	public REMOVE_Token(final int keyWord, final Object value) {
		this(null, keyWord, value);
	}

	/// Create a new Token.
	/// @param keyWord the Token's keyword attribute
	public REMOVE_Token(final int keyWord) {
		this(keyWord, null);
	}
	...
	public boolean equals(final Object other) {
		REMOVE_Token othr = (REMOVE_Token) other;
