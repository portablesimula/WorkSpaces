...
public class AttributeOutputStream {
    ...
    public void writeKind(int i) throws IOException {
		if(TRACE) Util.println("AttributeOutputStream.writeKind: "+i+':'+ObjectKind.edit(i));
    ...
    public void writeType(Type type) throws IOException {
		if(TRACE) Util.println("AttributeOutputStream.writeType: "+type);
		if(type == null)
			oupt.writeByte(0);
		else {
    ...
    public void writeBoolean(boolean b) throws IOException {
		if(TRACE) Util.println("AttributeOutputStream.writeBoolean: "+b);
		oupt.writeBoolean(b);
	}
    ...
    public void writeShort(int i) throws IOException {
		if(TRACE) Util.println("AttributeOutputStream.writeInt: "+i);
    ...
    public void writeConstant(Object c) throws IOException {
		if(TRACE) Util.println("AttributeOutputStream.writeConstant: "+c);
    ...
    public void writeString(String s) throws IOException {
		if(TRACE) Util.println("AttributeOutputStream.writeString: "+s);
    ...
    public void writeIdentifier(Identifier id) throws IOException {
		if(TRACE) Util.println("AttributeOutputStream.writeIdentifier: "+id);
		if(id == null) {
			oupt.writeShort(0);
		} else {
			String s = id.value;
    ...
    public void writeObj(SyntaxElement obj) throws IOException {
		if(obj == null) {
			if(TRACE) Util.println("AttributeOutputStream.writeObj: null");
			writeKind(ObjectKind.NULL);
		} else if(obj.OBJECT_SEQU != 0) {
			if(TRACE) Util.println("AttributeOutputStream.writeObj: ObjectReference "+(obj.OBJECT_SEQU));
			writeKind(ObjectKind.ObjectReference);
			oupt.writeShort(obj.OBJECT_SEQU);
		} else {
			obj.OBJECT_SEQU = CoreGlobal.Object_SEQU++;
			if(TRACE) Util.println("AttributeOutputStream.writeObj: OBJECT_SEQU="+obj.OBJECT_SEQU+": "+obj.getClass().getSimpleName()+"  "+obj);
