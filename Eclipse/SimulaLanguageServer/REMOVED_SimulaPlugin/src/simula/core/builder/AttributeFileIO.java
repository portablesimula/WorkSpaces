...
//			Util.println("AttributeFileIO.readAttributeFile: " + DocumentManager.externalJarFileNames);
			...
			if(d!=null) {
				...
				if (DocumentManager.verbose)
					Util.println("***       Read External " + ObjectKind.edit(module.declarationKind) + ' ' + module.identifier
