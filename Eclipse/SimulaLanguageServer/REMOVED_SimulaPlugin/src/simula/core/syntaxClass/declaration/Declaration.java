...
//		Util.println("Declaration.acceptDeclaration: BEFORE acceptIdentifier");
		Identifier maybePrefix = Parse.acceptIdentifier(simBuilder);
//		Util.println("Declaration.acceptDeclaration: AFTER acceptIdentifier");
		if (maybePrefix != null) {
//			Util.println("Declaration.acceptDeclaration: maybePrefix="+maybePrefix);
			if (Parse.accept(simBuilder, KeyWord.CLASS)) {
//				Util.println("Declaration.acceptDeclaration: CLASS");
				decl = ClassDeclaration.expectClassDeclaration(simBuilder, maybePrefix);
			} else {
//				Util.println("Declaration.acceptDeclaration: NOT CLASS");
