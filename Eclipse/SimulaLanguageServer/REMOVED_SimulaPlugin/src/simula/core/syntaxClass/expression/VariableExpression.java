...
//			Util.println("VariableExpression.expectVariable: GOT BEGPAR");
			variable.params = new Vector<Expression>();
			do {
//				Util.println("VariableExpression.expectVariable: GOT BEGPAR OR COMMA");
...
//			Util.println("VariableExpression.expectVariable: GOT ENDPAR");
		}
		if (Option.internal.TRACE_PARSE)
...
//		Util.println("VariableExpression.deChecking BEGIN Variable(" + identifier.value + ").doChecking: type=" + type);
//		Util.IERR("");
...
//			case ObjectKind.PrefixedBlock:
			...
			case ObjectKind.UndefinedDeclaration:
				if(params != null) {
//					Util.println("VariableExpression.doChecking: " + ObjectKind.edit(declaredAs.declarationKind) + " " + declaredAs);
...
//		Util.println("VariableExpression.doChecking: DONE: " + ObjectKind.edit(declaredAs.declarationKind) + ": " + declaredAs);
...
//			case ObjectKind.Switch:
	...
	private String editVariable(final SimulaCoder simCoder, final String rightPart) {
		...
		Declaration declaredAs = meaning.declaredAs;
//		Util.println("VariableExpression.editVariable: " + identifierValue()+" "+meaning);
//		ASSERT_SEMANTICS_CHECKED();
		StringBuilder s;
		switch (declaredAs.declarationKind) {
			case ObjectKind.ArrayDeclaration:
...
//						.getfield(ivar.getFieldRefEntry(pool));
	...
	public void printTree(final int indent) {
		Util.println(edTreeIndent(indent)+this);
	}
