...
public class ObjectReferenceMap {
	...
	public void print() {
		Util.println("ObjectReferenceMap.print: BEGIN Print OBJECT REFERENCE TABLE:");
		Map<Integer, SyntaxElement> map = objectReference;
		map.forEach((key, value) -> Util.println("   " + key + "  <==>  " + value));
		Util.println("ObjectReferenceMap.print: ENDOF Print OBJECT REFERENCE TABLE:");
	}
