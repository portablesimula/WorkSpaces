...
//	    server.initialized();
	    ...
	    // 1)
	    String program1 = "class Demo; begin\r\n"              // Line 0
	    		+ "    comment demo mockup: 1;\r\n"           // Line 1
	    		+ "    procedure p(x); integer x; begin\r\n"  // Line 2
	    		+ "       real pi = 3.14;\r\n"                // Line 3
	    		+ "       outtext\"line with error\");\r\n"   // Line 4 missing ( at pos 14
	    ...
	    // 2) End comment over flere linjer
	    ...
	    // 3) Text konstant over flere linjer
	    ...
	    // 4) Comment over flere linjer
	    String program4 = "class A; begin\r\n"   // Line 0
	    		+ "    comment proc p\r\n"       // Line 1
	    		+ "        endelig\r\n"          // Line 2
	    		+ "    ;"                        // Line 3
	    		+ " end";                        // Line 4
...
//	    DocumentManager.didOpen(demoUri, version, program1);
//	    DocumentManager.didOpen(demoUri, version, program2);
//	    DocumentManager.didOpen(demoUri, version, program3);
//	    DocumentManager.didOpen(demoUri, version, program4);
//	    DocumentManager.didOpen(demoUri, version, program.replace("\r\n", "\n"));
//	    DocumentManager.didOpen(demoUri, version, program1.replace("\r\n", "\n"));
//	    DocumentManager.didOpen(demoUri, version, program2.replace("\r\n", "\n"));
//	    DocumentManager.didOpen(demoUri, version, program3.replace("\r\n", "\n"));
	    DocumentManager.didOpen(demoUri, version, program4.replace("\r\n", "\n"));
