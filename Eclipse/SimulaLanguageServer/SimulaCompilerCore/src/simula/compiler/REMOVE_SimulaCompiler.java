...
public final class REMOVE_SimulaCompiler {
...
//	}
	...
	public REMOVE_SimulaCompiler(final String inputFileName, final Reader reader) {
		IO.println("NEW SimulaCompiler(final String sourceFileName, final Reader reader)");
		CoreGlobal.initiate();
		this.reader = reader;
		if(SimulaCompiler.verbose) Util.println("Input Source File: " + inputFileName);
		...
		SimulaCompiler.sourceFileName = inputFile.getName();
		SimulaCompiler.sourceName = Util.getBaseName(inputFileName);
		...
		if (SimulaCompiler.verbose) {
			...
			Util.println("compilerMode         " + SimulaCompiler.compilerMode);
	...
	public REMOVE_SimulaCompiler(final String sourceFileName) {
		IO.println("NEW SimulaCompiler(final String sourceFileName)");
//		Global.initiate();
//		this.reader = reader;
		
		if(SimulaCompiler.verbose) Util.println("Input Source File: " + sourceFileName);
		...
		SimulaCompiler.sourceFileName = inputFile.getName();
		SimulaCompiler.sourceName = Util.getBaseName(sourceFileName);
		CoreGlobal.sourceFileDir = inputFile.getParentFile();
		if(CoreGlobal.sourceFileDir == null) CoreGlobal.sourceFileDir = new File(System.getProperty("user.dir"));
