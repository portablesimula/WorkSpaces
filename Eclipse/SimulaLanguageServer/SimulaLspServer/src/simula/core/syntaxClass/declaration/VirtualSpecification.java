...
//				Util.println("VirtualSpecification.expectVirtualPart: LEXER TOKEN: " + simBuilder.getCurrentParserToken());
...
//				Util.println("\n\nVirtualSpecification.expectVirtualPart: AFTER: " + identifierValue());
	...
	public static VirtualSpecification getVirtualSpecification(final Declaration decl) {
		...
		if(scope.prefix.equals("ERRMSG")) {
			Util.println("VirtualSpecification.getVirtualSpecification: decl="+decl);
			Util.println("VirtualSpecification.getVirtualSpecification: scope="+scope+"   PREFIX="+scope.prefix);
	...
	public void printTree(int indent) {
		Util.println(SyntaxElement.edIndent(indent)+this.getClass().getSimpleName()+"    "+this);
	}
