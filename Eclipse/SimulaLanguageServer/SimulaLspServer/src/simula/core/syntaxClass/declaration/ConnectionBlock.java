...
//		ASSERT_SEMANTICS_CHECKED();
	...
	public void printTree(final int indent) {
		...
		Util.println(edTreeIndent(indent) + "CONNECTION " + identifierValue() + tail + "  PrefixLevel=" + prefixLevel() + "  declaredIn="+this.declaredIn);
		printDeclarationList(indent + 1);
		statement.printTree(indent + 1);
		Util.println(edTreeIndent(indent)+"END CONNECTION "+identifierValue());
	}
