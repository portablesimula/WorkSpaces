...
//			getPrefixClass().doChecking();
	...
	public void buildByteCode(SimulaCoder simCoder, CodeBuilder codeBuilder) {
		...
		if (this.isPreCompiledFromFile != null) {
			if(DocumentManager.verbose)
				Util.println("Skip  buildClassFile: " + this.identifierValue()+" extends " + this.prefix + " -- It is read from " + isPreCompiledFromFile);		
		} else {
	...
	public byte[] buildClassFile(final SimulaCoder simCoder) {
		...
		if(DocumentManager.verbose) Util.println("Begin buildClassFile: PrefixecBlock " + CD_ThisClass + " extends " + CD_SuperClass);
	...
	public void printTree(final int indent) {
		...
		Util.println(edTreeIndent(indent) + blockPrefix + " begin" + tail + " nParam=" + parameterList.size());
