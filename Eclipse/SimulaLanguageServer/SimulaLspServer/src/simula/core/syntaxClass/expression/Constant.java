...
/// @see simula.core.builder.SimulaLexer
public final class Constant extends Expression {
    ...
    /// @return the resulting Constant
    static Constant evaluate(final SimulaBuilder simBuilder, final int opr,final Number rhn) { 
    ...
    /// @param rhn a right hand Number
    /// @return the resulting Constant
    static Constant evaluate(final SimulaBuilder simBuilder, final Number lhn,final int opr,final Number rhn) { 
...
//				Util.println("Constant.toJavaCode: "+value.getClass().getSimpleName()+"  "+value);
