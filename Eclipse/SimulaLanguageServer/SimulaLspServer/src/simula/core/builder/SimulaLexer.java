...
//    	    	Util.println("SimulaLexer.getNext: EOF_MARK: " + current);
//    	    	Thread.dumpStack();
    		}
    	} else {
    		current = sourceText.charAt(nextPos++);
    	}
//    	Util.println("SimulaLexer.getNext: " + current);
//		Util.println("SimulaLexer.getNext(nextPos: " + (nextPos - 1)
...
//		Util.println("SimulaLexer.nextCharIs("+c+") ==> current: " + edChar((char) current) + ", next: " + edChar((char) next) + " ==> " + (next == c));
//    	Util.println("SimulaLexer.getNext: " + current);
//		Util.println("SimulaLexer.getNext(nextPos: " + (nextPos - 1)
//				+ ") ==> nextPos: " + nextPos + " current: " + edChar((char) current)
//				+"  CALLED FROM: " + Util.calledFrom(3, 25));
