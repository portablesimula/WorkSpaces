...
/// "https://github.com/portablesimula/EclipseWorkSpaces/blob/main/SimulaCompiler_JDK17/Simula/src/simula/compiler/JavaSourceFileCoder.java"><b>Source File</b></a>.
/// 
...
public final class JavaSourceFileCoder {
	...
	public JavaSourceFileCoder(final BlockDeclaration blockDeclaration) {
		...
		String javaFileName = Global.tempJavaFileDir + "/" + blockDeclaration.getJavaIdentifier() + ".java";
		javaOutputFile = new File(javaFileName);
		if(Option.internal.keepJava != null)
			System.out.println("Java Source file are written to: " + javaFileName);
		try {
