...
//		if(Option.internal.TESTING_JDK17) {
//			ASSERT_SEMANTICS_CHECKED();
//			String prfx = (first) ? "" : "else ";
//			String cid = classDeclaration.getJavaIdentifier();
//			if (!impossibleWhenPart) {
//				String inspid = connectionStatement.inspectedVariable.toJavaCode();
//				String cvar = this.connectionBlock.connID;
//				JavaSourceFileCoder.code(prfx + "if(" + inspid + " instanceof " + cid + ") {","WHEN " + cid + " DO ");
//				JavaSourceFileCoder.code(cid + " " + cvar +" = (" + cid + ")" + inspid + ";");
