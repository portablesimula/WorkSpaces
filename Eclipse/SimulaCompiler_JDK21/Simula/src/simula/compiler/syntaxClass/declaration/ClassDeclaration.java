...
/// "https://github.com/portablesimula/EclipseWorkSpaces/blob/main/SimulaCompiler_JDK17/Simula/src/simula/compiler/syntaxClass/declaration/ClassDeclaration.java">
/// <b>Source File</b></a>.
/// 
...
//	}
	...
	public static ClassDeclaration readObject(AttributeInputStream inpt) throws IOException {
		...
		JavaClassInfo info=new JavaClassInfo();
		info.externalIdent=cls.getJavaIdentifier();
		info.prefixIdent=cls.externalPrefixIdent;
		JavaClassInfo.put(info.externalIdent,info);
