...
/// "https://github.com/portablesimula/WorkSpaces/Eclipse/blob/main/SimulaCompiler2/Simula/src/simula/compiler/syntaxClass/expression/ObjectGenerator.java"><b>Source File</b></a>.
/// 
...
public final class ObjectGenerator extends Expression {
	...
	private ObjectGenerator(final PsiBuilder simBuilder, final String ident,final Vector<Expression> params) {
	...
	static Expression expectNew(PsiBuilder simBuilder) {
		if (Option.internal.TRACE_PARSE)
			Util.TRACE("Parse ObjectGenerator, current=" + Parse.currentToken(simBuilder));
