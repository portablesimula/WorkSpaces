...
/// "https://github.com/portablesimula/WorkSpaces/Eclipse/blob/main/SimulaCompiler2/Simula/src/simula/compiler/syntaxClass/declaration/SimpleVariableDeclaration.java">
/// <b>Source File</b></a>.
/// 
...
public class SimpleVariableDeclaration extends Declaration {
	...
	public SimpleVariableDeclaration(final Type type, final String identifier) {
		super("SimpleVariableDeclaration", identifier);
...
//	}
	...
	public SimpleVariableDeclaration() {
		super("SimpleVariableDeclaration", null);
		this.declarationKind = ObjectKind.SimpleVariableDeclaration;
	}
