...
private final Tree myPsiTree;  // Extends JTree
...
//		@Override
//		public void updatePsiTree(PsiElement toSelect, TextRange selectRangeInEditor) {
		public void updatePsiTree(PsiElement toSelect) {
