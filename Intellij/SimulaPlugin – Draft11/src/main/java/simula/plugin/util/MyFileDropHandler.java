...
//        VirtualFile sourceDir = VFS.getSourceDir(project);
            VirtualFile sourceDir = VfsUtil.createDirectoryIfMissing(project.getBaseDir(), "src");
            if (sourceDir == null) {
    ...
    private void copyFile(@NotNull Project project, @NotNull VirtualFile vFile, @NotNull VirtualFile targetDir) {
        ApplicationManager.getApplication().invokeLater(() -> {
            ...
            WriteAction.run(() -> {
                try {
                    ...
                    VirtualFile copiedFile = VfsUtil.copyFile(this, vFile, targetDir);
