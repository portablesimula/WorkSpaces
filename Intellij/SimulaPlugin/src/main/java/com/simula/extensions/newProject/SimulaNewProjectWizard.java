...
import com.simula.extensions.start_close.SimulaStartupActivity;
...
//                        VirtualFile simDir = ResourceCopier.getSimulaSamplesDir();
//                        VfsUtil.copyDirectory(this, simDir, ssfDir, null);

                        ResourceCopyUtils.copySamplesToSsf(project);
