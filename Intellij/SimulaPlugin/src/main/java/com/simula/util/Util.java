...
//        URL imageUrl = INSTANCE.getClass().getClassLoader().getResource("images/" + iconName);
       URL imageUrl = INSTANCE.getClass().getClassLoader().getResource("icons/" + iconName);
        if (imageUrl != null) {
...
//        Messages.showMessageDialog(msg,"ERROR", Util.getSimulaIcon("sim.png"));
    ...
    public static void ALERT(String msg) {
        ...
        ApplicationManager.getApplication().invokeLater(() -> {
            WriteAction.run(() -> {
                try {
                    int answer = Dialogs.optionDialog(finalMsg, "ALERT", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, "Continue", "Exit");
