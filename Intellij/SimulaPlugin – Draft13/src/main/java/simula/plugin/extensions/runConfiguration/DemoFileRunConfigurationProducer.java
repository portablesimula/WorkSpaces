...
public class DemoFileRunConfigurationProducer extends LazyRunConfigurationProducer<DemoRunConfiguration> {

    @NotNull
    @Override
    public ConfigurationFactory getConfigurationFactory() {
//        if(true) throw new RuntimeException("MyFileRunConfigurationProducer.getConfigurationFactory: ");
        System.out.println("DemoFileRunConfigurationProducer.getConfigurationFactory: ");
        ...
        return new DemoConfigurationFactory(new DemoRunConfigurationType());
  }
    ...
    protected boolean setupConfigurationFromContext(
            @NotNull DemoRunConfiguration configuration,
