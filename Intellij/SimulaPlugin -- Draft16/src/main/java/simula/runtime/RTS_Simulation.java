...
/// 
/// Link to GitHub: <a href="https://github.com/portablesimula/WorkSpaces/Eclipse/blob/main/SimulaCompiler2/Simula/src/simula/runtime/RTS_Simulation.java"><b>Source File</b></a>.
/// 
...
//			System.out.println("RTS_Simulation.SIM_TRACE: sqs.first="+first.getClass().getSimpleName());
//			RTS_EVENT_NOTICE n = (RTS_EVENT_NOTICE) first;
//			System.out.println("RTS_Simulation.SIM_TRACE: sqs.first="+n);
//			
//			System.out.println("RTS_Simulation.SIM_TRACE: SQS: " + msg);
//			while(n != null) {
//				System.out.println("RTS_Simulation.SIM_TRACE: "+n);
